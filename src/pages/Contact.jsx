...
const Contact = () => {
	return (
		<>
		<Banner 
		top_heading="WELCOME to Contact PAGE"
		heading="Contact Us"
		...
		<Right_image 
       top_small_heading="About Contact Details"
       heading="Contact US"
       ...
       btnname="Learn More"
       imgsrc="./images/contact-right.jpg"
        />
        ...
        <Newsletter_component />
          ...
          <div class="contact-info">
            <div class="contact-info-item">
              ...
              <div class="contact-info-text">
                <h2>address</h2>
                <span>1215 Lorem Ipsum, Ahmedabad </span> 
          ...
          <div class="contact-info">
            <div class="contact-info-item">
              ...
              <div class="contact-info-text">
                <h2>E-mail</h2>
                <span>prakash.montu_92@live.com</span> 
                <span>prakash.montu_92@live.com</span> 
              </div>
            </div>            
          </div>                
          ...
          <div className="responsive-padding contact-field">
